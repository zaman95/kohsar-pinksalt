    ...
    <form onSubmit={handleSubmit(onSubmit)} className="mt-7" noValidate>
      ...
      <div className="grid grid-cols-1 gap-[18px] sm:grid-cols-2">
        ...
        <label className="block">
          ...
          <input className={fieldClass} placeholder="+1 555 000 0000" {...register("whatsapp")} />
        </label>
        <label className="block">
          <span className={labelClass}>Product interest *</span>
          <select className={fieldClass} defaultValue="" {...register("productInterest")}>
        ...
        <label className="block">
          <span className={labelClass}>Shipping destination (port)</span>
